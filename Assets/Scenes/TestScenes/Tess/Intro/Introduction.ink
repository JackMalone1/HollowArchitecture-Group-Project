=== introduction ===
You finally finish the 7-day trek through the woods to find yourself in front of the forgotten, dilapidated village. This village has been lost to time by the rest of the world; the village doesn't seem interested in interacting with the rest of the world. There seems to be nothing left of the simple life and joy that you were told existed here. The abominations have been too regular as of late it seems.
-> describe_villagers

VAR DESCRIBE_VILLAGERS = 3
=== describe_villagers ===
+ [{The few villagers that are left appear to be living in a life of squalor.|Everyone ignores your gaze as you attempt to find the person that had asked you here in the first place.|As you get to the town hall, you see what you can only presume is some cross between a human and an alien of some kind. Not quite human, yet not too different either.}]
    {
    - DESCRIBE_VILLAGERS <= 1:
        -> info_from_mother
    - else:
